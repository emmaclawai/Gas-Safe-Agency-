...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Form submission to hello@gassafebot.co.uk
    ...
    return (
      <div className="bg-[#111118] border border-[#1E1E2E] rounded-2xl p-8 text-center">
        ...
        <button
          ...
          className="mt-6 px-6 py-2 border border-[#1E1E2E] rounded-lg hover:border-[#00D4FF] transition-colors"
        >
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="px-8 py-3 bg-gradient-to-r from-[#00D4FF] to-[#8B5CF6] text-[#0A0A0F] font-semibold rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isSubmitting ? (
